...
public:
    ...
    static SpriteButton* create(Texture2D *aTexture, const ccMenuCallback& callback);
    static SpriteButton* create(Texture2D *aTexture, const ccMenuCallback& callback, float scale);
    
    void initWithScale(float scale, float zoomPercentage, const ccMenuCallback& callback);
